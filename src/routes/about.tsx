...
function About() {
  return (
    <div className="min-h-screen bg-[#f9fafb] text-[#1a1a1a] overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-32 pb-20 relative flex flex-col items-center">
        {/* The Lanyard Strap */}
        ...
        <div className="vp-swing-card relative mt-2 w-full max-w-[480px] bg-[#e5e5e5] rounded-[24px] shadow-xl overflow-hidden border border-[#d4d4d4]" style={{ transformOrigin: "top center" }}>
          ...
          <div className="absolute left-0 top-0 bottom-0 w-12 bg-[#d4d4d4] flex items-center justify-center">
          ...
          <div className="pl-16 pr-8 py-8 flex items-start gap-6">
            {/* Profile Picture Placeholder */}
            <div className="w-[84px] h-[84px] rounded-full bg-gradient-to-br from-[#00d4ff] to-[#00ff88] shrink-0 border-2 border-white shadow-sm flex items-center justify-center text-white text-2xl font-bold font-serif">
              PK
            </div>
            ...
            <div className="flex-1">
              <div className="mb-6">
                <h1 className="text-[22px] font-semibold leading-none mb-1 text-[#1a1a1a]" style={{ fontFamily: "var(--font-sans)" }}>
                  Parv Khandelwal
                </h1>
                <p className="text-[14px] text-[#666] font-medium">Java Backend Developer</p>
              </div>
